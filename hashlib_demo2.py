...
# m.update('5c25ae996e712fc8e93c10a1b9fd3b42dd408aaa65f4c3e4dfe8982800000000'.encode())
m.update('Prof!'.encode())
for i in messages:
    m.update(i.encode())
m.update(int(1730910874).to_bytes(8,'big'))
m.update('663135608617883'.encode())
print(m.hexdigest()) # should be